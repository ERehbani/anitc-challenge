...
const Description = () => {
  return (
    <div className="">
      <section
        id="findout"
        className="bg-[#F3EEE8]   mx-auto px-4 py-24 lg:w-full flex flex-col lg:flex-row lg:justify-around gap-12">
        <div className="w-full mx-auto flex flex-col lg:flex-row lg:justify-around gap-12">
          <div className="lg:w-[650px] ml-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl text-[#706458] lg:w-3/4 font-light mb-8">
              We stay by your side to design your projects
            </h2>
            <Button
              variant="link"
              className="mt-4 text-[#A06056] hover:text-rose-700 p-0">
      ...
      <section className="bg-white py-12">
        <div className="w-[83%] mx-auto px-4 flex justify-around my-16 max-sm:flex-col max-sm:space-y-5">
          <div className="lg:w-full mr-28">
            ...
            <Button
              variant={"link"}
              className="flex items-center text-[#A06056] hover:underline p-0">
              Learn more <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </div>
          <div className="flex items-center space-x-4 lg:w-full">
            <Input
              type="email"
              placeholder="email@address.com"
              className="max-w-md border-none bg-[#F3EEE84D] text-[#706458E5]"
            />
            <Button className="bg-[#534B42] font-[Karla] text-white hover:text-[#534B42] hover:border hover:border-[#534B42] hover:shadow-sm hover:shadow-black transition-all">
              Subscribe
            </Button>
          </div>
        </div>
